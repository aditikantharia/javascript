...
document.querySelector("h1").addEventListener("clcik",function()
{
...
//event handler context -->html elment
//class --> blank object
...
}//savethis obj.into this keyword

function temp_a(){
    console.log(this);
}

//function.call(object_name) --> this keyword ni value set karva mate call method no upyog kariye chiye 
//temp.a.call(obj5);

//function.apply(object_name)-->this keyword ni value set karva mate call method no upyog kariye chiye 
//temp.a.apply(obj5);

//function.bind(object_name)-->this keyword ni value set karva mate call method no upyog kariye chiye 
let fnc =temp_a.bindf(obj5);//blank objeect create
fnc();
//console.log(fnc);